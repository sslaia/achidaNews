...
public class HealthFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.menu_health));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String SOURCES = null;
        String CATEGORY = getString(R.string.category_health);
        ...
        connectionLiveData.observe(getViewLifecycleOwner(), new Observer<ConnectionModel>() {
            ...
            public void onChanged(ConnectionModel connection) {
                if (!connection.getIsConnected()) {
                    ...
                    navController.navigate(R.id.health_to_connection);
                }
            }
        });
    }
