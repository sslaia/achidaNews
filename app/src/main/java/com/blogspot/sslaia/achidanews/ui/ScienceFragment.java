...
public class ScienceFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.menu_science));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String SOURCES = null;
        String CATEGORY = getString(R.string.category_science);
        ...
        connectionLiveData.observe(getViewLifecycleOwner(), new Observer<ConnectionModel>() {
            ...
            public void onChanged(ConnectionModel connection) {
                if (!connection.getIsConnected()) {
                    ...
                    navController.navigate(R.id.science_to_connection);
                }
            }
        });
    }
